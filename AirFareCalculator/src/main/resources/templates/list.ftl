                ...
                <div class="alert alert-info" role="alert" ng-if="errorMessage">{{errorMessage}}</div>
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-2 control-lable" for="source">Source Airport</label>
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-2 control-lable" for="destination">Destination Airport</label>
	                ...
	                <div class="row">
	                    <div class="form-actions floatRight">
	                    	<button name="searchBtn" type="button" ng-click="ctrl.searchFare()" class="btn btn-primary btn-sm" ng-disabled="selectedSource.originalObject == undefined || selectedDest.originalObject == undefined">Retrieve Fare</button>
